...
// Auto-extract code from callback URL (OpenAI/Gemini/Grok/Antigravity)
// e.g., http://localhost:8085/callback?code=xxx...&state=...
watch(authCodeInput, (newVal) => {
  if (props.platform !== 'openai' && props.platform !== 'gemini' && props.platform !== 'grok' && props.platform !== 'antigravity') return
  ...
  if (trimmed.includes('?') && trimmed.includes('code=')) {
    try {
      ...
      if ((props.platform === 'openai' || props.platform === 'gemini' || props.platform === 'grok' || props.platform === 'antigravity') && stateParam) {
      ...
      if ((props.platform === 'openai' || props.platform === 'gemini' || props.platform === 'grok' || props.platform === 'antigravity') && stateMatch && stateMatch[1]) {
