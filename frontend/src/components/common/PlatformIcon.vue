<template>
  ...
  <svg v-else-if="platform === 'gemini' || platform === 'antigravity'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
  ...
  <svg v-else-if="platform === 'grok'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4.2 5.2h4.15l3.7 5.05 3.8-5.05H20l-5.9 7.72 6.15 7.88H16.1l-4.02-5.32-4.08 5.32H3.85l6.16-7.95L4.2 5.2Z" />
  </svg>
  <!-- Custom logo (settings/cog) -->
