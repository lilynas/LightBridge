...
export type Platform = 'anthropic' | 'openai' | 'grok' | 'antigravity' | 'gemini'
...
const BADGE: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-500/10 text-zinc-700 border-zinc-500/30 dark:text-zinc-200',
  antigravity: 'bg-blue-500/10 text-blue-600 border-blue-500/30 dark:text-blue-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-500/10 text-zinc-700 dark:bg-zinc-500/10 dark:text-zinc-200',
  antigravity: 'bg-blue-500/10 text-blue-600 dark:bg-blue-500/10 dark:text-blue-300',
...
const BORDER: Record<Platform, string> = {
  ...
  antigravity: 'border-blue-500/20 dark:border-blue-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  grok: 'bg-gradient-to-r from-zinc-500 to-zinc-700',
  antigravity: 'bg-gradient-to-r from-blue-400 to-blue-500',
...
const TEXT: Record<Platform, string> = {
  ...
  antigravity: 'text-blue-600 dark:text-blue-400',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-600 dark:text-zinc-200',
  antigravity: 'text-blue-500 dark:text-blue-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-800 text-white hover:bg-zinc-900 active:bg-black dark:bg-zinc-200 dark:text-zinc-950 dark:hover:bg-zinc-100',
  antigravity: 'bg-blue-500 text-white hover:bg-blue-600 active:bg-blue-700 dark:bg-blue-500/80 dark:hover:bg-blue-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  grok: 'bg-zinc-100 text-zinc-700 dark:bg-zinc-800/70 dark:text-zinc-200',
  antigravity: 'bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  grok: 'from-zinc-600 to-zinc-900',
  antigravity: 'from-blue-500 to-blue-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'grok' || p === 'antigravity' || p === 'gemini'
}
