...
export default {
      ...
      dataActions: '数据操作',
      toolActions: '工具',
      repairOpenAIOAuthPlatform: '修复 OpenAI 平台',
      repairOpenAIOAuthPlatformConfirm: '将扫描被模块迁移错误改为 module、或被标记为 Gemini OAuth 但实际属于 OpenAI OAuth 的账号，并恢复为 OpenAI。真正的 Gemini OAuth 和其他模块账号不会被修改。是否继续？',
      repairOpenAIOAuthPlatformCompleted: '修复完成：已修复 {repaired} 个账号，扫描 {scanned} 个可疑账号。',
      repairOpenAIOAuthPlatformCompletedWithErrors: '修复完成但有错误：已修复 {repaired}，失败 {failed}，扫描 {scanned}。',
      repairOpenAIOAuthPlatformNoChanges: '未发现需要修复的 OpenAI 账号。扫描 {scanned} 个可疑账号。',
      repairOpenAIOAuthPlatformFailed: '修复 OpenAI 平台失败',
      viewColumns: '列显示',
      ...
      usageWindow: {
        ...
        grokBuildReauthRequired: 'Grok Build Token 需要重新授权',
        grokBuildReauthDetail: '当前 Access Token 缺少 Grok Build OAuth 上下文，已自动停止调度。请重新完成 Grok Build OAuth。',
        grokObserved: '已观测',
        grokUnknown: '未知',
