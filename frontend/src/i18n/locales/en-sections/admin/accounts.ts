...
export default {
      ...
      dataActions: 'Data',
      toolActions: 'Tools',
      repairOpenAIOAuthPlatform: 'Repair OpenAI Platform',
      repairOpenAIOAuthPlatformConfirm: 'This will scan accounts incorrectly changed to module by provider migration, plus Gemini OAuth accounts that actually belong to OpenAI, and restore their OpenAI platform. Real Gemini OAuth and other module accounts will not be modified. Continue?',
      repairOpenAIOAuthPlatformCompleted: 'Repair completed: repaired {repaired} account(s), scanned {scanned} suspect account(s).',
      ...
      repairOpenAIOAuthPlatformNoChanges: 'No OpenAI accounts need repair. Scanned {scanned} suspect account(s).',
      repairOpenAIOAuthPlatformFailed: 'Failed to repair OpenAI platform',
      viewColumns: 'Columns',
      ...
      usageWindow: {
        ...
        grokBuildReauthRequired: 'Grok Build token needs re-authorization',
        grokBuildReauthDetail: 'The access token lacks the Grok Build OAuth context and has been removed from scheduling. Complete Grok Build OAuth again.',
